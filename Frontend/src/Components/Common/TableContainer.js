  ...
  return (
    <Fragment>
      ...
      <Row>
        <Col lg={6}>
          <Pagination>
            <PaginationItem> <PaginationLink onClick={previousPage} > Anterior </PaginationLink> </PaginationItem>
            <PaginationItem> <PaginationLink > <strong>{pageIndex + 1} </strong></PaginationLink></PaginationItem>
            <PaginationItem> <PaginationLink > de </PaginationLink> </PaginationItem>
            <PaginationItem> <PaginationLink > <strong>{pageOptions.length}</strong> </PaginationLink> </PaginationItem>
            <PaginationItem> <PaginationLink onClick={nextPage} disabled={!canNextPage}> Siguiente </PaginationLink> </PaginationItem>
          </Pagination>
        </Col>
      </Row>
    </Fragment>
